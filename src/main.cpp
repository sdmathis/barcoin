...
uint256 hashGenesisBlock("0x8278753b93410a3fc6bf1911d02ea7910d37f0a45830d814c2c0f475e15317dc");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc5f1f5328bbdbbdf37085a4e00858e3e4d34ad1cdaab4239c9e4b2dada82f22a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1412618724; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 335851;

        if (fTestNet)
        {
            block.nTime    = 1412610070;
            block.nNonce   = 1580183;
        }
